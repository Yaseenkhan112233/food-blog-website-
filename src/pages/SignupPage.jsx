...
const SignupPage = () => {
          ...
          <div className="md:flex">
            ...
            <div className="md:w-64 bg-orange-50 md:min-h-[600px] p-6">
              <div className="flex flex-col items-center mb-8">
                ...
                <h2 className="font-neue font-medium text-xl text-slate-800">
                  {username || "User"}
                </h2>
                <p className="font-neue font-light text-sm text-slate-600 truncate max-w-[180px]">
                  {email}
                </p>
              </div>
              ...
              <nav className="mt-8">
                <ul className="space-y-2">
                  <li>
                    <button
                      onClick={() => setActiveTab("profile")}
                      className={`font-neue font-normal w-full text-left px-4 py-3 rounded-lg flex items-center transition-colors ${
                        activeTab === "profile"
                          ? "bg-white text-orange-500 shadow-sm"
                          : "text-slate-700 hover:bg-orange-100"
                      }`}
              ...
              <div className="mt-auto pt-6">
                <button
                  onClick={handleLogout}
                  className="font-neue font-normal w-full flex items-center justify-center px-4 py-2 mt-10 bg-red-100 text-red-600 hover:bg-red-200 rounded-lg transition-colors"
                >
                  <LogOut className="w-4 h-4 mr-2" />
                  Sign Out
                </button>
            ...
            <div className="flex-1 p-6 md:p-8">
              ...
              {error && (
                <div className="flex items-center bg-red-50 text-red-700 p-4 rounded-lg mb-6 text-sm">
                  <AlertCircle className="w-5 h-5 mr-2 flex-shrink-0" />
                  <span className="font-neue font-light">{error}</span>
                </div>
              )}
              ...
              {successMessage && (
                <div className="flex items-center bg-green-50 text-green-700 p-4 rounded-lg mb-6 text-sm">
                  <CheckCircle className="w-5 h-5 mr-2 flex-shrink-0" />
                  <span className="font-neue font-light">{successMessage}</span>
                </div>
              )}

              {activeTab === "profile" && (
                <>
                  <h1 className="font-neue font-medium text-2xl text-gray-800 mb-6">
                    Profile Information
                  </h1>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl mb-8 border border-gray-100">
                    <div className="flex flex-wrap items-center">
                      <div className="w-full md:w-1/4">
                        <span className="font-neue font-normal text-sm text-gray-500">
                          MEMBER SINCE
                        </span>
                      </div>
                      <div className="w-full md:w-3/4 mt-2 md:mt-0">
                        <span className="font-neue font-light flex items-center text-gray-800">
                          <Calendar className="w-4 h-4 mr-2 text-orange-400" />
                          {currentUser?.metadata?.creationTime
                            ? new Date(
                                currentUser.metadata.creationTime
                  ...
                  <form onSubmit={handleProfileUpdate} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label
                          htmlFor="username"
                          className="font-neue font-normal block text-sm text-gray-700 mb-2"
                        >
                          Username
                        </label>
                        <input
                          ...
                          value={username}
                          onChange={(e) => setUsername(e.target.value)}
                          className="font-neue font-light w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-300 transition-all"
                          required
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={email}
                          readOnly
                          className="font-neue font-light w-full px-4 py-3 border border-gray-200 rounded-lg bg-gray-100 text-gray-500"
                        />
                        <p className="font-neue font-light text-xs text-gray-500 mt-1">
                          Email cannot be changed
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="pt-4">
                      <button
                        type="submit"
                        disabled={loading}
                        className="font-neue font-normal px-6 py-3 bg-orange-100 text-orange-700 hover:bg-orange-200 rounded-lg transition-colors disabled:opacity-70 flex items-center justify-center"
                      >
                        {loading ? (
                          <span className="flex items-center">
                            <svg
              ...
              {activeTab === "account" && (
                <>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl mb-6 border border-gray-100">
                    <h3 className="font-neue font-normal text-lg text-gray-800 mb-4">
                      Email Address
                    </h3>
                    <p className="font-neue font-light text-gray-600 mb-3">
                      Your current email address is <strong>{email}</strong>
                    </p>
                    <p className="font-neue font-light text-sm text-gray-500">
                      This email is used for login and notifications.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                    ...
                    <p className="font-neue font-light text-gray-600 mb-4">
                      Password changes are not available directly from this
                      page. If you need to reset your password, please use the
                      login page's "Forgot Password" option.
                    </p>
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-md p-8">
        <h1 className="font-neue font-medium text-2xl text-center mb-6">
          Create an Account
        </h1>
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div>
            <label
              htmlFor="username"
              className="font-neue font-normal block text-sm text-gray-700 mb-1"
            >
              Username
            </label>
            <input
              ...
              value={username}
              onChange={(e) => setUsername(e.target.value)}
              className="font-neue font-light w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-300"
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="font-neue font-normal w-full bg-orange-100 text-orange-700 hover:bg-orange-200 py-2 rounded-md transition-colors disabled:opacity-70"
          >
            {loading ? "Creating Account..." : "Sign Up"}
          </button>
        </form>
        ...
        <div className="mt-4">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="font-neue font-light px-2 bg-white text-gray-500">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <button
            onClick={handleGoogleSignUp}
            disabled={loading}
            className="font-neue font-normal mt-4 w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-md py-2 px-4 text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-70"
          >
            <svg
              width="18"
              height="18"
        ...
        <p className="font-neue font-light mt-6 text-center text-sm text-gray-600">
          Already have an account?{" "}
          <Link to="/signin" className="text-orange-600 hover:underline">
            Sign in
          </Link>
