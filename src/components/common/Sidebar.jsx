...
//         <h1 className="hidden lg:block text-2xl font-bold text-slate-800 mb-6 text-center pt-4">
//           Welcome
//         </h1>
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col">
        {/* Close button for mobile */}
        <div className="flex justify-between items-center px-4 py-4 lg:hidden">
          <h1 className="font-neue font-medium text-2xl text-slate-800">Menu</h1>
          <button onClick={onClose} className="text-slate-600 text-xl">
            &times;
          </button>
        </div>
        ...
        {/* Sidebar Title (desktop) */}
        <h1 className="hidden lg:block font-neue font-medium text-2xl text-slate-800 mb-6 text-center pt-4">
          Welcome
        </h1>
          ...
          <ul className="space-y-2">
            {menuItems.map((item) => (
              <li key={item.id}>
                ...
                >
                  {item.icon}
                  <span className="font-neue font-normal">{item.label}</span>
                </button>
              </li>
            ))}
          </ul>
