// // components/cards/GenerateRecipeCard.jsx
...
//     <div
//       onClick={onClick}
//       className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl p-8 cursor-pointer hover:shadow-lg transition-all duration-300 hover:scale-105 group relative overflow-hidden"
//     >
...
//         <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 shadow-sm group-hover:shadow-md transition-all duration-300">
//           <ChefHat className="w-8 h-8 text-blue-600 group-hover:scale-110 transition-transform duration-300" />
//         </div>

//         <div className="space-y-1">
//           <h3 className="font-bold text-slate-800 group-hover:text-blue-800 transition-colors">Generate</h3>
//           <h3 className="font-bold text-slate-800 group-hover:text-blue-800 transition-colors">Your Own</h3>
//           <h3 className="font-bold text-slate-800 group-hover:text-blue-800 transition-colors">Recipe</h3>
//         </div>
