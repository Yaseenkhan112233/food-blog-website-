...
const RecipeCard = ({
  ...
  return (
    <div
      ...
      className="bg-[#EFF0F5] rounded-xl overflow-hidden  hover:shadow-md transition-all duration-300 cursor-pointer group"
    >
      {/* Recipe Image / Header */}
      ...
      <div className="p-3 sm:p-4">
        <div className="flex justify-between items-start mb-2">
          <div className="w-full">
            <h4 className="font-neue font-medium text-base sm:text-lg text-slate-800 mb-1 truncate">
              {title}
            </h4>
            <p className="font-neue font-light text-sm text-slate-600 truncate">{subtitle}</p>
          </div>
        </div>

        <div className="flex flex-wrap justify-between font-neue font-light text-sm text-slate-500 gap-2">
